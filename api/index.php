...
<head>
    ...
    <title>Output PHP | Alifiahfa's Library API</title>
...
<body>
        ...
        <div class="container-fluid">
          <a class="navbar-brand" href="/index.html">
            <img src="img/books.png" alt="Logo" height="40">
            Alifiahfa's Library
          </a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item"><a class="nav-link" href="/api/index.php"><i class="bi bi-skip-end-btn"></i> Lainnya</a></li>
            </ul>
    ...
    <div class="container my-4"> <h1>Isi lain dari website ini</h1>
        <?php
        echo "<p>Ini adalah contoh output PHP: Hello World</p>"; // Output PHP dalam paragraf
        ?>
        <ul>
            <li><a href="api/formulir_pengunjung.php">Formulir Data Pengunjung</a></li>
            <li><a href="api/tabel_perkalian.php">Tabel Perkalian</a></li>
